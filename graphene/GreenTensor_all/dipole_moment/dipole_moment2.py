...
def Efield_tot_QE(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp,x,y,z,omega0,kappa_factor_omega0,kappa_r_factor):
    """
    Parameters
    ----------
...
def Efield_tot(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp,x,y,z,omega0,kappa_factor_omega0,kappa_r_factor):
    """
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    

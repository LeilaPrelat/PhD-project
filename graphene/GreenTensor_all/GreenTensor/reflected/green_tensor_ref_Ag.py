...
def green_tensor_NUM_QE(omegac,epsi1,epsi2,omega_bulk,hbar_gamma_in,d,x,y,z,xD,yD,zD,zp):
    """
    Parameters
    ----------
    ...
    cond = 4*np.pi*alfac*sigma_DL(omega,omega_bulk,hbar_gamma_in,d)
...
def green_tensor_NUM(omegac,epsi1,epsi2,omega_bulk,hbar_gamma_in,d,x,y,z,xD,yD,zD,zp):
    """
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    

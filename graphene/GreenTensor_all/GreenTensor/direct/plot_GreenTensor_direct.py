...
plt.plot(list_x,listI05_v2,'-',color = 'black',label = 'analytical')
# plt.yscale('log')
if plot_sin_numerical == 1:
...
plt.plot(list_x,listI25_v2,'-',color = 'black',label = 'analytical')
# plt.yscale('log')
if plot_sin_numerical == 1:
...
plt.plot(list_x,listI06_v2,'-',color = 'black',label = 'analytical')
if plot_sin_numerical == 1:
...
plt.plot(list_x,listI26_v2,'-',color = 'black',label = 'analytical')
# plt.yscale('log')
if plot_sin_numerical == 1:
...
plt.plot(list_x,total2_re,'-',color = 'black',label = 'analytical')
# plt.yscale('log')
if plot_sin_numerical == 1:
...
plt.plot(list_x,total2_im,'-',color = 'black',label = 'analytical')
# plt.yscale('log')
if plot_sin_numerical == 1:

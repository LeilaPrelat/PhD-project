...
try:
    ...
    from fieldE_direct_numerical6 import Efield_NUM_QE_2terms,Efield_NUM_2terms 
...
if plot_vs_OmegaTHz == 1:
    ...
    list_x = np.linspace(0.01,0.08,17)
...
if plot_num_QE == 1 and plot_sin_QE == 0:
    ...
    header1 = header0 + '     Re(E_{dir,x}) analytic     Re(E_{dir,x}) QE num     Re(E_{dir,x}) sin QE num' + ', ' +  title
...
if plot_num_QE == 1 and plot_sin_QE == 0:
    ...
    header2 = header0 + '     Im(E_{dir,x}) analytic     Im(E_{dir,x}) QE num     Im(E_{dir,x}) sin QE num' + ', ' +  title

...
path_save = path_basic + '/green_tensor_ref_zz'


err = 'green_tensor_ref_zz_graphene.py no se encuentra en ' + path_basic
try:
    sys.path.insert(1, path_basic)
    from green_tensor_ref_zz_graphene import green_tensor_ref_fresnel, green_tensor_ref_pole_aprox, green_tensor_PP2

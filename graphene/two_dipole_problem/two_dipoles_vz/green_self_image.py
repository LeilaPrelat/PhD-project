...
####       
    ...
    intselfB_re_x,err = integrate.quad(IntselfB_function_re_xx, cota_inf1, cota_sup1, limit = 500)
    intselfB_im_x,err = integrate.quad(IntselfB_function_im_xx, cota_inf1, cota_sup1, limit = 500)
#    
#    print(intselfB_re_x)

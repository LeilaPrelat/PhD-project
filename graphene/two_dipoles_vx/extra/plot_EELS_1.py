...
title4 = r'$x_1$ = %i nm, $x_2$ = %i nm, b = %i nm, zp = %i nm' %(x1*1e3,x2*1e3,b*1e3,zp*1e3)
...
graph(title,labelx,r'$\Gamma_{dip}$ + $\Gamma_{\parallel}$ [meV]',tamfig,tamtitle,tamletra,tamnum,labelpadx,labelpady,pad)
#    plt.plot(listx,listy_re_ana,'.',ms = ms,color = 'purple',label = 'analytical')
plt.plot(listx,listy_re_ana,'.-',ms = ms,color = 'purple',label = 'semi analytical')

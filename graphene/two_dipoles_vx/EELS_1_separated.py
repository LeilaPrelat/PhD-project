...
try:
    ...
    from dipole_moment import dipole_moment_x_ana_2,dipole_moment_x_ana
except ModuleNotFoundError:
...
def EELS_1_ana(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp,x1,z1,x2,z2,omega01,kappa_factor_omega01,kappa_r_factor1,omega02,kappa_factor_omega02,kappa_r_factor2):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
def EELS_2_ana(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp,x1,z1,x2,z2,omega01,kappa_factor_omega01,kappa_r_factor1,omega02,kappa_factor_omega02,kappa_r_factor2):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
    ...
    p2 = dipole_moment_x_ana_2(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp,x1,z1,x2,z2,omega01,kappa_factor_omega01,kappa_r_factor1,omega02,kappa_factor_omega02,kappa_r_factor2)
    
    Eref2 = Efield_ref_ana(omegac,epsi1,epsi2,hbmu,hbgama,x2,z2,b,zp,int_v)
    Edir2 = Efield_ANA(omegac,epsi1,x2,z2,b,int_v)

    rta = -1j*p2*(Eref2 + Edir2) 
    omega = omegac*c
    cte_que_no_puse_en_los_campos = (omega)**2 # e/omega 

...
#%%
graph(title,labelx,r'Re$\{p_x\}$/e',tamfig,tamtitle,tamletra,tamnum,labelpadx,labelpady,pad)
...
graph(title,labelx,r'Im$\{p_x\}$/e',tamfig,tamtitle,tamletra,tamnum,labelpadx,labelpady,pad)
#    plt.plot(listx,listy_re_ana,'.',ms = ms,color = 'purple',label = 'analytical')

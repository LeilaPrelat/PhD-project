...
def phi_many_dipoles_ana_n(omegac,epsi1,epsi2,hbmu,hbgama,int_v,zp,x,y,z,a,b,n,omega0,kappa_factor_omega0,kappa_r_factor):     
    """    
    Parameters
    ----------
...
#        print('warning kp<kx:' )
    ...
    exp_electron = np.exp(-alfa_pv2*k1*(2*zp - z))*np.exp(1j*termy*np.abs(y)) 
...
def phi_many_dipoles_num_n(omegac,epsi1,epsi2,hbmu,hbgama,int_v,zp,x,y,z,a,b,n,omega0,kappa_factor_omega0,kappa_r_factor):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
def phi_many_dipoles_pole_aprox_n(omegac,epsi1,epsi2,hbmu,hbgama,int_v,zp,x,y,z,a,b,n,omega0,kappa_factor_omega0,kappa_r_factor):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    

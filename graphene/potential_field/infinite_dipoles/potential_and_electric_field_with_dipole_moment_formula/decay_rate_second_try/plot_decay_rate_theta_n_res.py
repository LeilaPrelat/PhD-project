...
#    a_max = np.real(lambda_SP)*Nmax/(int_v + 1)
    ...
    listx = np.linspace(30,100,200)
    listx = np.linspace(40,110,200)
...
def function_real_ana(theta,zp_nano,energy0_meV,Nmax):
    ...
    rta = decay_rate_theta_inf_dipoles_ana_res(omegac0,epsi1,epsi2,hbmu,hbgama,int_v,zp,a,b,Nmax,theta)

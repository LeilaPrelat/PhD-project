...
#%%
#
#def decay_rate_theta_many_dipoles_ana_n_creo_que_mal(omegac,epsi1,epsi2,hbmu,hbgama,int_v,zp,a,b,n,px,py,pz,theta):     
#    """    
#    Parameters
#    ----------
...
def decay_rate_theta_many_dipoles_ana_n(omegac,epsi1,epsi2,hbmu,hbgama,int_v,zp,a,b,n,px,py,pz,theta):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    

...
path_constants =  path_basic.replace('/potential_field/many_potential_Javier_formula/creo_que_mal/num_vs_ana','')
path_2 =  path_basic.replace('/num_vs_ana','')

path_save = path_basic + '/' + 'many_potential1'
...
try:
    ...
    from potential_many_dipoles import phi_many_dipoles_num, phi_many_dipoles_ana
...
def function_real_num(z_nano,energy0):
    ...
    rta = phi_many_dipoles_num(omegac0,epsi1,epsi2,hbmu,hbgama,x0,y0,z,a,Ndipoles,zp,int_v,px,py,pz)
    # print(rta)
    return rta.real
...
def function_real_ana(z_nano,energy0):
    ...
    rta = phi_many_dipoles_ana(omegac0,epsi1,epsi2,hbmu,hbgama,x0,y0,z,a,Ndipoles,zp,int_v,px,py,pz)

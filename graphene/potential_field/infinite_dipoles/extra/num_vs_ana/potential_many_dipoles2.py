...
def phi_many_dipoles_num2(omegac,epsi1,epsi2,hbmu,hbgama,x,y,z,a,zp,int_v,px,py,pz):
    """
    Parameters
    ----------
...
#        print(n)
    ...
    ################### I6 ###############################################    
        ...
        int_tot0 = int_tot0 + int1_re + 1j*int1_im + int2_re + 1j*int2_im + term1
#        print(int_tot0)    
...
def phi_many_dipoles_pole_approx(omegac,epsi1,epsi2,hbmu,hbgama,x,y,z,a,zp,int_v,px,py,pz):
    """
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
def phi_many_dipoles_ana2_wrong(omegac,epsi1,epsi2,hbmu,hbgama,x,y,z,a,N,zp,int_v,px,py,pz):
    """
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
#    print('hola')
    ...
    nmax =  (kp - omega/v)*a/(2*np.pi)    #maximum order 
    nmax = int(nmax)
#    print(nmax)
...
#        print(n)
    ...
    ################### I1 ################################################
        ...
        term2 = -2*np.pi*Rp*(px*kx + py*ky)*exp_xy*exp_z
        
        term3 = -pz*2*np.pi*1j*Rp*kp*exp_xy*exp_z
        
    ################### I1 ################################################
        int_tot0 = term1 + term2 + term3 + int_tot0
#        
#        print(int_tot0)
...
def phi_many_dipoles_ana2(omegac,epsi1,epsi2,hbmu,hbgama,x,y,z,a,zp,int_v,px,py,pz):
    """
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
#            ky = - ky
    ...
    ################### I1 ################################################
        ...
        term3 = -pz*2*np.pi*1j*Rp*kp*np.abs(kp)*exp_xy*exp_z/ky
...
#%%omegac0,epsi1,epsi2,hbmu,hbgama,x0,y0,z0,a,zp,int_v,px,py,pz

    
def integral_neglecting(omegac,epsi1,epsi2,hbmu,hbgama,x,y,z,a,zp,int_v,px,py,pz):
    """
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
    ...
    kp = np.real(kp)            # principal value
    alfa_p = np.real(alfa_p)     # principal value
...
#        print(n)
    ...
    ################### I6 ###############################################    
        ...
        int_tot0 = int_tot0 + int1_re + 1j*int1_im + int2_re + 1j*int2_im 
#        print(int_tot0)    
#
#        print(int_tot0)
    return int_tot0/factor

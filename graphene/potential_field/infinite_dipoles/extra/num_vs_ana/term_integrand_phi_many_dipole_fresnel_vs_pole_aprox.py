...
def phi_many_dipoles_integrand_term1_fresnel(omegac,epsi1,epsi2,hbmu,hbgama,x,y,a,N,zp,int_v,px,alpha_y):
    """
    Parameters
    ----------
...
def phi_many_dipoles_integrand_term1_rp(omegac,epsi1,epsi2,hbmu,hbgama,x,y,a,N,zp,int_v,px,alpha_y):
    """
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    

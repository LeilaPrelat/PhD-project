...
try:
    ...
    from potential_many_dipoles2 import phi_many_dipoles_num2, phi_many_dipoles_ana2,phi_many_dipoles_pole_approx
...
title4 = r'b = %inm, x=%inm, y=%inm' %(b*1e3,x0*1e3,y0*1e3)
...
def function_real_num(z_nano,energy0):
    ...
    rta = phi_many_dipoles_num2(omegac0,epsi1,epsi2,hbmu,hbgama,x0,y0,z,a,zp,int_v,px,py,pz)
    # print(rta)
    return rta.real
...
def function_real_ana(z_nano,energy0):
    ...
    rta = phi_many_dipoles_ana2(omegac0,epsi1,epsi2,hbmu,hbgama,x0,y0,z,a,zp,int_v,px,py,pz)
...
def function_real_pole_approx(z_nano,energy0):
    omegac0 = energy0*1e-3/aux 
    z = z_nano*1e-3 

    rta = phi_many_dipoles_pole_approx(omegac0,epsi1,epsi2,hbmu,hbgama,x0,y0,z,a,zp,int_v,px,py,pz)
    
    return rta.real

def function_imag_pole_approx(z_nano,energy0):
    omegac0 = energy0*1e-3/aux 
    z = z_nano*1e-3 
...
if plot_vs_E == 1: 
    ...
    for value in listx: 
        ...
        y_re_pp = function_real_pole_approx(z0,value)
        y_im_pp = function_imag_pole_approx(z0,value)

...
title4 = r'px = %i, py = %i, pz = %i, xD = %inm' %(px,py,pz,xD*1e3)
...
if plot_xy_3D == 1 :    #omega = 0.7*1e12
    ...
    def function_real(x_nano,y_nano):
        ...
        rta = electric_potential(omegac0,epsi1,epsi2,hbmu,hbgama,x,y,z0,xD,yD,zD,zp,px,py,pz)
        return rta.real
    ...
    def function_real(y_nano,z_nano):
        ...
        rta = electric_potential(omegac0,epsi1,epsi2,hbmu,hbgama,x0,y,z,xD,yD,zD,zp,px,py,pz)
        return rta.real
    ...
    def function_real(x_nano,z_nano):
        ...
        rta = electric_potential(omegac0,epsi1,epsi2,hbmu,hbgama,x,y0,z,xD,yD,zD,zp,px,py,pz)
        return rta.real
...
if save_graphs == True:
    os.chdir(path_save)
    plt.tight_layout()
    plt.savefig('Re_potential' + label1 + '.png', format='png')
...
if save_graphs == True:
    os.chdir(path_save)
    plt.tight_layout()
    plt.savefig('Re_potential_log' + label1 + '.png', format='png')
...
if save_graphs == True:
    plt.tight_layout()
    plt.savefig('Im_potential' + label1 + '.png', format='png')

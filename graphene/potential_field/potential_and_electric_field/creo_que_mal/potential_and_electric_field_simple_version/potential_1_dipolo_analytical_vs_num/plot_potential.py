...
try:
    ...
    from potential import electric_potential_sin_aprox_RP_conQE, electric_potential_aprox_RP
...
def function_real_num(z_nano,energy0):
    ...
    rta = electric_potential_sin_aprox_RP_conQE(omegac0,epsi1,epsi2,hbmu,hbgama,x0,y0,z,xD,yD,zD,zp,px,py,pz)
    # print(rta)
    return rta.real
...
def function_real_ana(z_nano,energy0):
    ...
    rta = electric_potential_aprox_RP(omegac0,epsi1,epsi2,hbmu,hbgama,x0,y0,z,xD,yD,zD,zp,px,py,pz)

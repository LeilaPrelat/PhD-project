...
def electric_potential_ana(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x,y,z,list_xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor):     
    """    
    Parameters
    ----------
...
def electric_potential_num(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x,y,z,list_xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor):
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    

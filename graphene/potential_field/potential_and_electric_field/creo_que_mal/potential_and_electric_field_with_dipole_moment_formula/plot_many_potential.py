...
try:
    ...
    from many_potential import electric_potential_ana, electric_potential_num
...
title1 = r'v = c/%i $\mu$m/s, $\kappa$ = %.2f$\omega_0$, $\kappa_r$ = %.2f$\kappa$, $E_0$=%.4feV' %(int_v, kappa_factor_omega0, kappa_r_factor, energy0_pol)     
title2 = r'$\hbar\mu$ = %.2feV, $\hbar\gamma$ = %.4feV' %(hbmu,hbgama) 
title3 = r'$z_p$=%inm, px=%i, py=%i, pz=%i' %(zp*1e3,px,py,pz)
title4 = r'$z_p$=%inm, px=%i, py=%i, pz=%i, yD=%inm, Ndip = %i' %(zp*1e3,px,py,pz,yD*1e3,Ndipoles)
title5 = r'b = %inm, zD=%inm, x=%inm, y=%inm' %(b*1e3,zD*1e3,x0*1e3,y0*1e3)
labelp = r'_px%i_py%i_pz%i_E0%.4f_Ndip%i' %(px,py,pz,energy0_pol,Ndipoles)
...
def function_real_num(z_nano,energy0):
    ...
    rta = electric_potential_num(omegac0,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x0,y0,z,list_xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor)
    # print(rta)
    return rta.real
...
def function_real_ana(z_nano,energy0):
    ...
    rta = electric_potential_ana(omegac0,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x0,y0,z,list_xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor)

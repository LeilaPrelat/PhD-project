...
try:
    sys.path.insert(1, path_constants)
    from dipole_moment import dipole_moment_ana,dipole_moment_num
except ModuleNotFoundError:
...
def electric_field_x_ana(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x,y,z,xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor):
...
#    k0 = omegac #=omega/c
    ...
    px,py,pz = dipole_moment_ana(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,omega0,kappa_factor_omega0,kappa_r_factor)
...
def electric_field_x_num(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x,y,z,xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor):
...
#    k0 = omegac #=omega/c
    ...
    px,py,pz = dipole_moment_num(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,omega0,kappa_factor_omega0,kappa_r_factor)
...
def electric_field_y_ana(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x,y,z,xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor):
...
def electric_field_y_num(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x,y,z,xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor):
...
def electric_field_z_ana(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x,y,z,xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor):
...
def electric_field_z_num(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x,y,z,xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor):
...
def electric_field_tot_ana(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x,y,z,xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor):
    
    Ez = electric_field_z_ana(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x,y,z,xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor)
        
    Ex = electric_field_x_ana(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x,y,z,xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor)
    
    Ey = electric_field_y_ana(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x,y,z,xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor)
        
    return np.abs(Ez)**2 + np.abs(Ex)**2 + np.abs(Ey)**2

#%%

def electric_field_tot_num(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x,y,z,xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor):
    
    Ez = electric_field_z_num(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x,y,z,xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor)
        
    Ex = electric_field_x_num(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x,y,z,xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor)
    
    Ey = electric_field_y_num(omegac,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,x,y,z,xD,yD,zD,omega0,kappa_factor_omega0,kappa_r_factor)

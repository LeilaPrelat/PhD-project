...
def green_self_num_mix(omegac,epsi1,epsi2,hbmu,hbgama,zp) :
    ...
    imaginary_part = np.imag(green_self_num(omegac,epsi1,epsi2,hbmu,hbgama,zp))
...
def dipole_moment_anav2_resonance(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
def dipole_moment_anav2_for_decay_rate_resonance(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
def dipole_moment_num(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp,omega0,kappa_factor_omega0,kappa_r_factor):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
def dipole_moment_pole_aprox(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp,omega0,kappa_factor_omega0,kappa_r_factor):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
def dipole_moment_pole_aprox_res(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    

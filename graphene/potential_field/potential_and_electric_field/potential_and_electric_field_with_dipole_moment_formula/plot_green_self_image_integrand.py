...
title = r'$z_p$=%inm, $\hbar\mu$ = %.2feV, $\hbar\omega$ = %i meV' %(zp*1e3,hbmu,energy0)
...
def function_num_xx_re(u):
    ...
    rtaself_x, rtaself_y, rtaself_z = green_self_num(omegac0,epsi1,epsi2,hbmu,hbgama,zp,u)
    # print(rta    
...
def function_pole_aprox_xx_re(u):
    ...
    rtaself_x, rtaself_y, rtaself_z  = green_self_pole_aprox(omegac0,epsi1,epsi2,hbmu,hbgama,zp,u)

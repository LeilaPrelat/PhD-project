...
path_save = path_basic + '/' + 'EELS_integrales'
...
try:
    ...
    from EELS_1dip_integrales import EELS_num_INT1, EELS_ana_INT1, EELS_num_INT2, EELS_ana_INT2,EELS_ana2_INT2, EELS_num_INT3, EELS_ana_INT3, EELS_ana_f_dir 
...
def function2_ana_re_v2(energy0,int_v0):
    omegac0 = energy0*1e-3/aux 

    rta = EELS_ana2_INT2(omegac0,epsi1,epsi2,hbmu,hbgama,int_v0,b,zp,omega0,kappa_factor_omega0,kappa_r_factor)
...
def function_tot_ana_re(energy0,int_v0):
    ...
    rta1 = EELS_ana_INT1(omegac0,epsi1,epsi2,hbmu,hbgama,int_v0,b,zp,omega0,kappa_factor_omega0,kappa_r_factor)
    rta2 = EELS_ana2_INT2(omegac0,epsi1,epsi2,hbmu,hbgama,int_v0,b,zp,omega0,kappa_factor_omega0,kappa_r_factor)
    rta3 = EELS_ana_INT3(omegac0,epsi1,epsi2,hbmu,hbgama,int_v0,b,zp,omega0,kappa_factor_omega0,kappa_r_factor)
    
    rta_dir = EELS_ana_f_dir(omegac0,epsi1,epsi2,hbmu,hbgama,int_v,b,zp,omega0,kappa_factor_omega0,kappa_r_factor)
    
    tot = rta1 + rta2 + rta3 +  rta_dir 
...
if plot_vs_E == 1:
    ...
    for value in listx: 
        ...
        y_re_ana_2_v2 = function2_ana_re_v2(E0,value2)  
...
graph(title,labelx,'Int 1',tamfig,tamtitle,tamletra,tamnum,labelpadx,labelpady,pad)
plt.plot(listx,listy_re_ana_1,'.-',ms = ms,color = 'purple',label ='analytical' )
plt.plot(listx,listy_re_num_1,'.-',ms = ms,color = 'lightseagreen',label ='numerical' )
plt.tight_layout()
...
graph(title,labelx,'Int 2',tamfig,tamtitle,tamletra,tamnum,labelpadx,labelpady,pad)
plt.plot(listx,listy_re_ana_2,'.-',ms = ms,color = 'purple',label ='analytical' )
plt.plot(listx,listy_re_ana_2_v2,'.-',ms = ms,color = 'darkred',label ='analytical 2' )
plt.plot(listx,listy_re_num_2,'.-',ms = ms,color = 'lightseagreen',label ='numerical' )
plt.tight_layout()
plt.legend(loc = 'best',markerscale=1.5,fontsize=tamlegend,frameon=0,handletextpad=0.2, handlelength=length_marker)
#if plot_vs_c == 1:
#    plt.yscale('log')
...
graph(title,labelx,'Int 3',tamfig,tamtitle,tamletra,tamnum,labelpadx,labelpady,pad)
plt.plot(listx,listy_re_ana_3,'.-',ms = ms,color = 'purple',label ='analytical' )
plt.plot(listx,listy_re_num_3,'.-',ms = ms,color = 'lightseagreen',label ='numerical' )
plt.tight_layout()
plt.legend(loc = 'best',markerscale=1.5,fontsize=tamlegend,frameon=0,handletextpad=0.2, handlelength=length_marker)
#if plot_vs_c == 1:
#    plt.yscale('log')
...
graph(title,labelx,'EELS',tamfig,tamtitle,tamletra,tamnum,labelpadx,labelpady,pad)
plt.plot(listx,listy_re_ana_tot,'.-',ms = ms,color = 'purple',label ='analytical' )
plt.plot(listx,listy_re_num_tot,'.-',ms = ms,color = 'lightseagreen',label ='numerical' )
plt.tight_layout()
plt.legend(loc = 'best',markerscale=1.5,fontsize=tamlegend,frameon=0,handletextpad=0.2, handlelength=length_marker)
#if plot_vs_c == 1:
#    plt.yscale('log')

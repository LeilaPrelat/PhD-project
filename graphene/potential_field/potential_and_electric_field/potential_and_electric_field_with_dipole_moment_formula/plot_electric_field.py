...
title1 = r'v = c/%i $\mu$m/s, $\kappa$ = %.2f$\omega_0$, $\kappa_r$ = %.2f$\kappa$, $E_0$=%.1fmeV' %(int_v, kappa_factor_omega0, kappa_r_factor, energy0_pol)     
title2 = r'$\hbar\mu$ = %.2feV, $\hbar\gamma$ = %.1fmeV' %(hbmu,hbgama*1e3) 
title3 = r'$z_p$=%inm, px=%i, py=%i, pz=%i' %(zp*1e3,px,py,pz)
title5 = r'b = %inm, $\varphi$=%i, z=%inm' %(b*1e3,phi,z*1e3)
labelp = r'_px%i_py%i_pz%i_E0%imev' %(px,py,pz,energy0_pol)
...
def function_real_ana(R_nano,energy0):
    ...
    rta = electric_field_ana_f(omegac0,epsi1,epsi2,hbmu,hbgama,int_v,px,py,pz,b,zp,phi,R,z,omega0,kappa_factor_omega0,kappa_r_factor)
...
#    listy_abs_num = []    
    ...
    for value in listx: 
        ...
        y_abs_ana = function_abs_ana(R0,value)
#        

...
try:
    ...
    from decay_rate_film3_resonance import EELS_film_ana_f_div_gamma0,EELS_film_ana_f_div_gamma0_v2
...
def function_imag_ana(energy0,int_v,zp_nano):
    ...
    rta1 = EELS_film_ana_f_div_gamma0_v2(omegac0,epsi1,epsi2,hbmu,hbgama,int_v,b,zp)

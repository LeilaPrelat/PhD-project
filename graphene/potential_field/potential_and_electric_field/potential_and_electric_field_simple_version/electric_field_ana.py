...
def electric_field_ana_f(omegac,epsi1,epsi2,hbmu,hbgama,phi,R,z,zp,px,py,pz):     
    """    
    Parameters
    ----------
...
#    J1 = special.jv(1,kp*R)
    ...
    term3 = pz*np.sign(z)*(Rp*np.pi*1j*kp_3*0.5*(H_minus1 - H1)*exp_electron - 3*R*np.abs(z)/(term_aux**(5/2)))

...
try:
    ...
    from electric_field_formula import electric_field_function
...
if plot_xy_3D == 1 :    #omega = 0.7*1e12
    ...
    def function_real(x_nano,y_nano):
        ...
        rta = electric_field_function(omegac0,epsi1,epsi2,hbmu,hbgama,x,y,z0,xD,yD,zD,b,zp,px,py,pz)
        return rta.real
    ...
    def function_real(y_nano,z_nano):
        ...
        rta = electric_field_function(omegac0,epsi1,epsi2,hbmu,hbgama,x0,y,z,xD,yD,zD,b,zp,px,py,pz)
        return rta.real
    ...
    def function_real(x_nano,z_nano):
        ...
        rta = electric_field_function(omegac0,epsi1,epsi2,hbmu,hbgama,x,y0,z,xD,yD,zD,b,zp,px,py,pz)
        return rta.real
    ...
    def function_real(energy0):
        ...
        rta = electric_field_function(omegac0,epsi1,epsi2,hbmu,hbgama,x0,y0,z0,xD,yD,zD,b,zp,px,py,pz)
        return rta    

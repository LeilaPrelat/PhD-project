...
def electric_field_function(omegac,epsi1,epsi2,hbmu,hbgama,x,y,z,list_xD,yD,zD,zp,px,py,pz):
...
#        R1 = np.sqrt((x - xD)**2 + (y - yD)**2)
        ...
        final = term1  + term2 + term3 + term4 + term5 + term6 + term7 + term8 + term9
        electric_field0 = final + electric_field0
    
    return  electric_field0

#%%
    

def electric_field_function_y(omegac,epsi1,epsi2,hbmu,hbgama,x,y,z,list_xD,yD,zD,zp,px,py,pz):
...
#        R1 = np.sqrt((x - xD)**2 + (y - yD)**2)
        ...
        final = term1  + term2 + term3 + term4 + term5 + term6 + term7 + term8 + term9
        electric_field0 = electric_field0 + final
        
    return  electric_field0

#%%

def electric_field_function_z(omegac,epsi1,epsi2,hbmu,hbgama,x,y,z,list_xD,yD,zD,zp,px,py,pz):
...
def electric_field_function_tot(omegac,epsi1,epsi2,hbmu,hbgama,x,y,z,list_xD,yD,zD,zp,px,py,pz):
    
    Ez = electric_field_function_z(omegac,epsi1,epsi2,hbmu,hbgama,x,y,z,list_xD,yD,zD,zp,px,py,pz)
        
    Ex = electric_field_function(omegac,epsi1,epsi2,hbmu,hbgama,x,y,z,list_xD,yD,zD,zp,px,py,pz)
    
    Ey = electric_field_function_y(omegac,epsi1,epsi2,hbmu,hbgama,x,y,z,list_xD,yD,zD,zp,px,py,pz)
    
    Ex2 = np.abs(Ex)
    Ey2 = np.abs(Ey)
    Ez2 = np.abs(Ez)
    
    return Ex2**2 + Ey2**2 + Ez2**2

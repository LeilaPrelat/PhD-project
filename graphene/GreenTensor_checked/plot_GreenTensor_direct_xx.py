...
path_save = path_basic + '/' + 'green_tensor_direct_xx'
...
try:
    ...
    from green_tensor_direct_xx import green_tensor_NUM_QE, green_tensor_ANA_QE
...
title = r'$\varphi$ = %i, z = %i nm, $z_e$ = %i nm' %(phi,z*1e3,ze*1e3)

...
try:
    ...
    from fieldE_direct_y import Efield_NUM_QE,Efield_ANA
except ModuleNotFoundError:
    print(err)


path_save = path_basic + '/' + 'fieldE_direct_y'
...
title = r'z = %i nm, $z_e$ = %i nm, v = c/%i' %(z*1e3,ze*1e3,int_v)
...
def Efield_ANA_QE_function(energy0,x_nano):
    ...
    return Efield_ANA(omegac0,epsi1,x,z,ze,int_v)
...
def Efield_NUM_QE_function(energy0,x_nano):
    ...
    return Efield_NUM_QE(omegac0,epsi1,x,z,ze,int_v)

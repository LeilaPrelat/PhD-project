...
path_save = path_basic + '/' + 'green_tensor_direct_zz'
...
try:
    ...
    from green_tensor_direct_zz import green_tensor_NUM_QE, green_tensor_ANA_QE
...
title = r'z = %i nm, $z_e$ = %i nm' %(z*1e3,ze*1e3)
    
R0 = 50
listx = np.linspace(15,80,N)
...
def green_tensor_ANA_QE_function(energy0,R_nano):
    ...
    return green_tensor_ANA_QE(omegac0,epsi1,R,z,ze)
...
def green_tensor_NUM_QE_function(energy0,R_nano):
    ...
    return green_tensor_NUM_QE(omegac0,epsi1,R,z,ze)

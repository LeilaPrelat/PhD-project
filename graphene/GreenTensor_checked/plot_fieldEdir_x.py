...
try:
    ...
    from fieldE_direct_x import Efield_NUM_QE,Efield_ANA
except ModuleNotFoundError:
    print(err)


path_save = path_basic + '/' + 'fieldE_direct_x'
...
title = r'$\varphi$ = %i, z = %i nm, $z_e$ = %i nm, v = c/%i' %(phi,z*1e3,ze*1e3,int_v)

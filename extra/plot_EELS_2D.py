...
graficar EELS con la misma convencion 
que el paper 370 (z hacia abajo, zplane>0, zelectron<0, particula en r = 0, medio 1 arriba del plano, 
...
err = 'EELS.py no se encuentra en ' + path_basic
try:
    sys.path.insert(1, path_basic)
    from EELS import fieldEELS
...
title2 = r'px = %i, py = %i, pz = %i, $\epsilon_1$ = %i, $\mu_1$ = %i, $\epsilon_2$ = %i, $\mu_2$ = %i' %(px,py,pz,epsi1,mu1,epsi2,mu2)
title = title1 + '\n' + title2 

listy1 = []
listy2 = []
for omegac in list_omegac: 
    valuey = fieldEELS(omegac,hbarmu,y,z_electron,z_plane,v,epsi1,epsi2,hbargama,px,py,pz)

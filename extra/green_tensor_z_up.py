...
def green_tensor_function(omegac,hbmu,z_plane,epsi_h,epsi1,epsi2,hbargama,px,py,pz):
    """
    Parameters
    ----------
    ...
    expA = lambda u: np.exp(1j*2*u*z_plane_barra) ## cambiar z por -z 
    expB = lambda u: np.exp(-2*u*z_plane_barra) ## cambiar z por -z

...
try:
    sys.path.insert(1, path_constants)
    from dipole_moment import dipole_moment_anav2,dipole_moment_anav2_resonance
except ModuleNotFoundError:
...
def decay_rate_theta_many_dipoles_ana_n(omegac,epsi1,epsi3,d_nano,int_v,zp,a,b,n,omega0,kappa_factor_omega0,kappa_r_factor,theta):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
    ...
    px,py,pz  = dipole_moment_anav2(omegac,epsi1,epsi3,d_nano,int_v,b,zp,omega0,kappa_factor_omega0,kappa_r_factor)  
#    list_dipoles = np.linspace(-Nmax,Nmax,2*Nmax + 1)
#            
    kx = omegac*int_v + 2*np.pi*n/a     
    expo_kx = np.exp(1j*kx*x)
...
def decay_rate_theta_many_dipoles_ana_n_resonance(omegac,epsi1,epsi3,d_nano,int_v,zp,a,b,n,theta):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    

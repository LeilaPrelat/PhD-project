...
title2 = r'v = c/%i, b = %i nm, $z_p$ = %i nm, $\hbar\omega_0$ = %i meV' %(int_v,b*1e3,zp*1e3,energy0_pol) 
...
labely = r'$\Gamma_n$'
title = title2 + '\n' +  title3  + ', $\hbar\omega$ = %.2f meV' %(E*1e3)
...
def function_real_ana(theta,Nmax):
    ...
    rta = decay_rate_theta_many_dipoles_ana_n(omegac0,epsi1,epsi3,d_nano,int_v,zp,a,b,Nmax,omega0,kappa_factor_omega0,kappa_r_factor,theta)
    # print(rta)
    return rta

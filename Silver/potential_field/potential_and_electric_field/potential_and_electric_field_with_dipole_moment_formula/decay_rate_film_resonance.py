...
try:
    sys.path.insert(1, path_basic)
    from green_self_image import green_self_ana2,green_self_num,green_self_pole_aprox,green_self_num_integral_inside_light_cone
except ModuleNotFoundError:
...
def green_self_num_mix(omegac,epsi1,epsi3,d_nano,zp) :      ####### dependendiendo del valor de "d", la pole approx puede 
                                                            #######  servir o no 
#    
#    if d_nano <= 1 :
#        rta1 =  
...
#    
    ...
    return green_self_ana2(omegac,epsi1,epsi3,d_nano,zp)
...
###################################################################################################
    ...
    cte_aux = alfac*(int_v**2)/(2*(np.pi**2)*(c*hb))
...
#    print(px_v,py_v,pz_v)
#    px_tot_2 = np.abs(px_v)**2 + np.abs(py_v)**2 + np.abs(pz_v)**2 
    rtaself_x1, rtaself_y1, rtaself_z1  =  green_self_num_integral_inside_light_cone(omegac,epsi1,epsi3,d_nano,zp)
    rtaself_x2, rtaself_y2, rtaself_z2  =  green_self_ana2(omegac,epsi1,epsi3,d_nano,zp)
    
    rtaself_x = rtaself_x2 - rtaself_x1
    rtaself_y = rtaself_y2 - rtaself_y1
    rtaself_z = rtaself_z2 - rtaself_z1

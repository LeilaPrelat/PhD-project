...
if plot_vs_theta == 1:
    ...
    listx = np.linspace(0.001,200,200) ### nanometros 
...
#    a_max = np.real(lambda_SP)*Nmax/(int_v + 1)
    ...
    listx = np.linspace(0.09,0.19,200)
...
def function_real_ana(theta,zp_nano,energy0,Nmax):
                
    omegac0 = energy0/(c*hb)  
    zp = zp_nano*1e-3
         
    rta = decay_rate_theta_inf_dipoles_ana_res(omegac0,epsi1,epsi3,d_nano,int_v,zp,a,b,n,theta)

...
def function_ana(zp_nano,energy0_eV,Nmax):
    ...
    rta = potential_inf_dipoles_ana(omegac0,epsi1,epsi3,d_nano,int_v,zp,a,b,Nmax)
...
def function_num(zp_nano,energy0_eV,Nmax):
    ...
    rta = potential_inf_dipoles_num(omegac0,epsi1,epsi3,d_nano,int_v,zp,a,b,Nmax)
...
def function_pole_aprox(zp_nano,energy0_eV,Nmax):
    ...
    rta = potential_inf_dipoles_pole_aprox(omegac0,epsi1,epsi3,d_nano,int_v,zp,a,b,Nmax)
...
#    plt.grid(1)
    ...
    for n in list_n:
        ...
        np.savetxt( 'phi_inf_dip_hBN_ana_' + labelp + 'n%i'%(n) + '.txt', tabla, fmt='%1.11e', delimiter='\t', header = header1)

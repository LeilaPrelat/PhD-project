...
path_save = path_basic + '/' + 'dipole_moment_integrals'
...
try:
    ...
    from dipole_moment_integrales import INT1_ana, INT2_ana, INT3_ana, INT1_pole_aprox, INT2_pole_aprox, INT3_pole_aprox, INT1_num, INT2_num, INT3_num
...
label1 = 'vs_E' + labelp
listx = np.linspace(43,80,N)

title = title1  + '\n'  + title4 

def Int1_num(energy0):
    omegac0 = energy0*1e-3/aux 

    px_f = INT1_num(omegac0,epsi1,epsi3,d_nano,int_v,b,zp,omega0,kappa_factor_omega0,kappa_r_factor)
    # print(rta)

    return px_f


def Int2_num(energy0):
    omegac0 = energy0*1e-3/aux 

    px_f = INT2_num(omegac0,epsi1,epsi3,d_nano,int_v,b,zp,omega0,kappa_factor_omega0,kappa_r_factor)
    # print(rta)

    return px_f


def Int3_num(energy0):
    omegac0 = energy0*1e-3/aux 

    px_f = INT3_num(omegac0,epsi1,epsi3,d_nano,int_v,b,zp,omega0,kappa_factor_omega0,kappa_r_factor)
    # print(rta)
...
def Int1_ana(energy0):
    omegac0 = energy0*1e-3/aux 

    px_f = INT1_ana(omegac0,epsi1,epsi3,d_nano,int_v,b,zp,omega0,kappa_factor_omega0,kappa_r_factor)
    # print(rta)

    return px_f


def Int2_ana(energy0):
    omegac0 = energy0*1e-3/aux 

    px_f = INT2_ana(omegac0,epsi1,epsi3,d_nano,int_v,b,zp,omega0,kappa_factor_omega0,kappa_r_factor)
    # print(rta)

    return px_f


def Int3_ana(energy0):
    omegac0 = energy0*1e-3/aux 

    px_f = INT3_ana(omegac0,epsi1,epsi3,d_nano,int_v,b,zp,omega0,kappa_factor_omega0,kappa_r_factor)
    # print(rta)
...
def Int1_pole_aprox(energy0):
    omegac0 = energy0*1e-3/aux 

    px_f = INT1_pole_aprox(omegac0,epsi1,epsi3,d_nano,int_v,b,zp,omega0,kappa_factor_omega0,kappa_r_factor)
    # print(rta)

    return px_f


def Int2_pole_aprox(energy0):
    omegac0 = energy0*1e-3/aux 

    px_f = INT2_pole_aprox(omegac0,epsi1,epsi3,d_nano,int_v,b,zp,omega0,kappa_factor_omega0,kappa_r_factor)
    # print(rta)

    return px_f


def Int3_pole_aprox(energy0):
    omegac0 = energy0*1e-3/aux 

    px_f = INT3_pole_aprox(omegac0,epsi1,epsi3,d_nano,int_v,b,zp,omega0,kappa_factor_omega0,kappa_r_factor)
    # print(rta)
...
for value in listx: 
    ...
    y_ana1 = Int1_ana(value)  
    y_num1 = Int1_num(value)
    y_pole1 = Int1_pole_aprox(value)
    

    y_ana2 = Int2_ana(value)  
    y_num2 = Int2_num(value)
    y_pole2 = Int2_pole_aprox(value)


    y_ana3 = Int3_ana(value)  
    y_num3 = Int3_num(value)
    y_pole3 = Int3_pole_aprox(value)



    listy_re_ana1.append(np.real(y_ana1))
    listy_re_ana2.append(np.real(y_ana2))
    listy_re_ana3.append(np.real(y_ana3))

    listy_im_ana1.append(np.imag(y_ana1))
    listy_im_ana2.append(np.imag(y_ana2))
    listy_im_ana3.append(np.imag(y_ana3))
...
plt.plot(listx,listy_re_ana1,'.',ms = ms,color = 'purple',label = 'PP analytical')
...
#    plt.plot(listx,listy_re_ana,'.',ms = ms,color = 'purple',label = 'analytical')
plt.plot(listx,listy_im_ana1,'.',ms = ms,color = 'purple',label = 'PP analytical')
...
#    plt.plot(listx,listy_re_ana,'.',ms = ms,color = 'purple',label = 'analytical')
plt.plot(listx,listy_re_ana2,'.',ms = ms,color = 'purple',label = 'PP analytical')
...
#    plt.plot(listx,listy_re_ana,'.',ms = ms,color = 'purple',label = 'analytical')
plt.plot(listx,listy_im_ana2,'.',ms = ms,color = 'purple',label = 'PP analytical')
...
#    plt.plot(listx,listy_re_ana,'.',ms = ms,color = 'purple',label = 'analytical')
plt.plot(listx,listy_re_ana3,'.',ms = ms,color = 'purple',label = 'PP analytical')
...
#    plt.plot(listx,listy_re_ana,'.',ms = ms,color = 'purple',label = 'analytical')
plt.plot(listx,listy_im_ana3,'.',ms = ms,color = 'purple',label = 'PP analytical')

...
title5 = r'z = %inm, $\varphi$ = %i, d = %i nm' %(z0*1e3,phi0,d_nano)
...
def function_real_ana(R_nano,energy0):
    ...
    rta = potential_final_ana(omegac0,epsi1,epsi3,d_nano,phi0,R,z0,zp,px,py,pz)
...
def function_real_num(R_nano,energy0):
    ...
    rta = potential_final_num(omegac0,epsi1,epsi3,d_nano,phi0,R,z0,zp,px,py,pz)
...
def function_real_pole_aprox(R_nano,energy0):
    ...
    rta = potential_final_pole_aprox(omegac0,epsi1,epsi3,d_nano,phi0,R,z0,zp,px,py,pz)

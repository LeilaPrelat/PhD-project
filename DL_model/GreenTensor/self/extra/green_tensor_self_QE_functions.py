...
############ todo junto ###################################
    int_re = np.real((J0 + J2)*expB*alpha_parallel*(alpha_parallel*rp - rs/alpha_parallel))
    int_im = np.imag((J0 + J2)*expB*alpha_parallel*(alpha_parallel*rp - rs/alpha_parallel))

...
def dipole_moment_anav2(omegac,epsi_silica,d_nano,int_v,b,zp,omega0,kappa_factor_omega0,kappa_r_factor):     
    """    
    Parameters
    ----------
...
#    k1_2 = (k0*cte1)**2
 #   n_v1 = int_v/cte1
    ...
    rtaself_x, rtaself_y, rtaself_z  =  green_self_ana2(omegac,epsi_silica,d_nano,zp)
...
def dipole_moment_anav2_resonance(omegac,epsi_silica,d_nano,int_v,b,zp):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
def dipole_moment_anav2_for_decay_rate_resonance(omegac,epsi_silica,d_nano,int_v,b,zp):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
def dipole_moment_pole_aprox_resonance(omegac,epsi_silica,d_nano,int_v,b,zp):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    

...
def green_self_ana(omegac,epsi_silica,d_nano,zp_micro):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
def green_self_ana2(omegac,epsi_silica,d_nano,zp_micro):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
#    alfa_p = np.real(alfa_p)
    ...
    rtaself_x = kp*0.5*( (1 + 2*kp*zp_micro)/(4*zp_micro**2) + kp**2*special.exp1(arg)*expo_self  )
...
#    alfa_p = np.real(alfa_p)
    ...
    rtaself_x = kp*0.5*( (1 + 2*kp*zp_micro)/(4*zp_micro**2) + kp**2*np.pi*1j*expo_self  )
...
def green_self_num_integrand(omegac,epsi_silica,d_nano,zp_micro,u):
    """
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
####       
    ...
    IntselfB_function_xx = (u**2)*rp*expB_self
    
    
    rtaself_x = IntselfB_function_xx*cte_x
    rtaself_y = rtaself_x
    rtaself_z = 2*rtaself_x
...
def green_self_pole_aprox_integrand(omegac,epsi_silica,d_nano,zp_micro,u):
    """
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
####       
    ...
    IntselfB_function_re_xx =  u**2*rp*expB_self


    
    rtaself_x = IntselfB_function_re_xx*cte_x
    rtaself_y = rtaself_x
    rtaself_z = 2*rtaself_x
...
def green_self_pole_aprox_integrand_v2(omegac,epsi_silica,d_nano,zp_micro,u):
    """
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    

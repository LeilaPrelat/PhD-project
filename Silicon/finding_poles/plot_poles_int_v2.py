...
path_save = path_basic + '/poles_int_v2'
path_load = path_ctes
try:
...
def coef_TM_fresnel_int(omega_omegaWG,d):
    ...
    for j in range(len(sup_limits)):
        ...
        termEx_num_int_re,err = integrate.quad(rta_real, inf_limits_int, inf_limits_sup) 
        termEx_num_int_im,err = integrate.quad(rta_imag, inf_limits_int, inf_limits_sup) 

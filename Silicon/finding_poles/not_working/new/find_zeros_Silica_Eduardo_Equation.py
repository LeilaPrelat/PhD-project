...
for omega_omegaWG in list_omega_omegaWGA:
    ...
    if minimizar_formulas_Eduardo == 1:
        ...
        if k_TM1 == 0 :
            ...
            resTM1 = fsolve(k_parallel_WG_TM1_1var, [zeros_eqTM1A[k_TM1-1]])         
        ...
        if k_TM2 == 0 :
            ...
            resTM2 = fsolve(k_parallel_WG_TM2_1var, [zeros_eqTM2A[k_TM2-1]])
        ...
        if k_TE1 == 0 :
            ...
            resTE1 = fsolve(k_parallel_WG_TE1_1var, [zeros_eqTE1A[k_TE1-1]])
        ...
        if k_TE2 == 0 :
            ...
            resTE2 = fsolve(k_parallel_WG_TE2_1var, [zeros_eqTE2A[k_TE2-1]])
...
#list_omega_omegaWG = np.linspace(0.00001,4,N)
list_omega_omegaWGB =np.linspace(cota_sup_omega_omegaWG,cota_inf_omega_omegaWG,N)
omegaWG = (np.pi*c/d)/np.sqrt(epsilon2-1) 
cte_new = c/omegaWG
...
for omega_omegaWG in list_omega_omegaWGB:
    ...
    if minimizar_formulas_Eduardo == 1:
        ...
        if k_TM1 == 0 :
            ...
            resTM1 = fsolve(k_parallel_WG_TM1_1var, [zeros_eqTM1B[k_TM1-1]])         
        resTM1_v = np.float(resTM1)
        if k_air < resTM1_v < k_medium:
        ...
        if k_TM2 == 0 :
            ...
            resTM2 = fsolve(k_parallel_WG_TM2_1var, [zeros_eqTM2B[k_TM2-1]])
        resTM2_v = np.float(resTM2)            
        if k_air < resTM2_v < k_medium:
        ...
        if k_TE1 == 0 :
            ...
            resTE1 = fsolve(k_parallel_WG_TE1_1var, [zeros_eqTE1B[k_TE1-1]])
        resTE1_v = np.float(resTE1)            
        if k_air <= resTE1_v <= k_medium:
        ...
        if k_TE2 == 0 :
            ...
            resTE2 = fsolve(k_parallel_WG_TE2_1var, [zeros_eqTE2B[k_TE2-1]])
        resTE2_v = np.float(resTE2)            
        if k_air <= resTE2_v <= k_medium:
...
plt.plot(np.array(zeros_eqTE2A)*cte_new,list_omega_omegaWG_TE2A,'.',color = 'red',ms = 4, label = 'TE')
plt.plot(np.array(zeros_eqTE1A)*cte_new,list_omega_omegaWG_TE1A,'.',color = 'red',ms = 4)
plt.plot(np.array(zeros_eqTM2A)*cte_new,list_omega_omegaWG_TM2A,'.',color = 'blue',ms = 4, label = 'TM')
plt.plot(np.array(zeros_eqTM1A)*cte_new,list_omega_omegaWG_TM1A,'.',color = 'blue',ms = 4)

plt.plot(np.array(zeros_eqTE2B)*cte_new,list_omega_omegaWG_TE2B,'.',color = 'orange',ms = 4)
plt.plot(np.array(zeros_eqTE1B)*cte_new,list_omega_omegaWG_TE1B,'.',color = 'orange',ms = 4)
plt.plot(np.array(zeros_eqTM2B)*cte_new,list_omega_omegaWG_TM2B,'.',color = 'lightblue',ms = 4)
...
if len(list_omega_omegaWGA) == len(list_omega_omegaWGB):

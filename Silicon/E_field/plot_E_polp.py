...
path_save = path_basic + '/' + 'E_polp_with_PV'
#if not os.path.exists(path_save):
#    print('Creating folder to save graphs')
#    os.mkdir(path_save)

err = 'E_polp_with_PV.py no se encuentra en ' + path_basic
try:
    sys.path.insert(1, path_basic)
    from E_polp_with_PV import Ex_polp_num, Ex_polp_ana_and_PV, Ey_polp_num, Ey_polp_ana_and_PV, Ez_polp_num, Ez_polp_ana_and_PV
...
def Ex_real_ana(R_nano,omega_omegaWG):
    ...
    rta = Ex_polp_ana_and_PV(omega_omegaWG,d,R,phi0,z0,zp,px,py,pz,epsilon_pole)
...
def Ey_real_ana(R_nano,omega_omegaWG):
    ...
    rta = Ey_polp_ana_and_PV(omega_omegaWG,d,R,phi0,z0,zp,px,py,pz,epsilon_pole)
...
def Ez_real_ana(R_nano,omega_omegaWG):
    R = R_nano*1e-3 

    rta = Ez_polp_ana_and_PV(omega_omegaWG,d,R,phi0,z0,zp,px,py,pz,epsilon_pole)
    
    return rta.real

def Ez_imag_ana(R_nano,omega_omegaWG):
    R = R_nano*1e-3 
...
#    omega_omegaWG = omega0/omegaWG
    ...
    rta = Ex_polp_num(omega_omegaWG,d,R,phi0,z0,zp,px,py,pz)
...
#    omega_omegaWG = omega0/omegaWG
    ...
    rta = Ey_polp_num(omega_omegaWG,d,R,phi0,z0,zp,px,py,pz)
...
def Ez_real_num(R_nano,omega_omegaWG):
#    omega0 = energy0*1e-3/aux    
#    omega_omegaWG = omega0/omegaWG
    R = R_nano*1e-3

    rta = Ez_polp_num(omega_omegaWG,d,R,phi0,z0,zp,px,py,pz)
    
    return rta.real

def Ez_imag_num(R_nano,omega_omegaWG):
#    omega0 = energy0*1e-3/aux    
#    omega_omegaWG = omega0/omegaWG
    R = R_nano*1e-3
...
if plot_vs_R == 1: 
    ...
    for value in listx: 
        ...
        y_re_anaG3 = Ez_real_ana(value,omega_omegaWG0)
        y_im_anaG3 = Ez_imag_ana(value,omega_omegaWG0)        


        y_re_numG3 = Ez_real_num(value,omega_omegaWG0)
        y_im_numG3 = Ez_imag_num(value,omega_omegaWG0)  
...
plt.plot(listx,listy_re_anaG1,'.-',ms = ms,color = 'purple',label = 'PP analytical + PV')
...
plt.plot(listx,listy_im_anaG1,'.-',ms = ms,color = 'purple',label = 'PP analytical + PV')
...
plt.plot(listx,listy_re_anaG2,'.-',ms = ms,color = 'purple',label = 'PP analytical + PV')
...
plt.plot(listx,listy_im_anaG2,'.-',ms = ms,color = 'purple',label = 'PP analytical + PV')
...
plt.plot(listx,listy_re_anaG3,'.-',ms = ms,color = 'purple',label = 'PP analytical + PV')
...
plt.plot(listx,listy_im_anaG3,'.-',ms = ms,color = 'purple',label = 'PP analytical + PV')

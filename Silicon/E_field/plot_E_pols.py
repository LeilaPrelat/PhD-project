...
path_save = path_basic + '/' + 'E_pols_with_PV'
#if not os.path.exists(path_save):
#    print('Creating folder to save graphs')
#    os.mkdir(path_save)

err = 'E_pols_with_PV.py no se encuentra en ' + path_basic
try:
    sys.path.insert(1, path_basic)
    from E_pols_with_PV import Ex_pols_num, Ex_pols_ana_and_PV, Ey_pols_num, Ey_pols_ana_and_PV
...
def Ex_real_ana(R_nano,omega_omegaWG):
    ...
    rta = Ex_pols_ana_and_PV(omega_omegaWG,d,R,phi0,z0,zp,px,py,pz)
...
def Ey_real_ana(R_nano,omega_omegaWG):
    ...
    rta = Ey_pols_ana_and_PV(omega_omegaWG,d,R,phi0,z0,zp,px,py,pz)

...
def Ex_pols_num(omega_omegaWG,d,R,phi,z,zp,px,py,pz):     
    ...
    for j in range(len(sup_limits)):
        ...
        termEx_num_int_re,err = integrate.quad(termEx_num_re_f, inf_limits_int, inf_limits_sup, limit=100) 
        termEx_num_int_im,err = integrate.quad(termEx_num_im_f, inf_limits_int, inf_limits_sup, limit=100) 
...
def Ex_pols_pole_aprox(omega_omegaWG,d,R,phi,z,zp,px,py,pz):     
    ...
    for j in range(len(sup_limits)):
        ...
        termEx_pole_aprox_int_re,err = integrate.quad(termEx_num_re_f, inf_limits_int, inf_limits_sup, limit=100) 
        termEx_pole_aprox_int_im,err = integrate.quad(termEx_num_im_f, inf_limits_int, inf_limits_sup, limit=100) 
...
def Ey_pols_num(omega_omegaWG,d,R,phi,z,zp,px,py,pz):     
    ...
    for j in range(len(sup_limits)):
        ...
        termEy_num_int_re,err = integrate.quad(termEx_num_re_f, inf_limits_int, inf_limits_sup, limit=100) 
        termEy_num_int_im,err = integrate.quad(termEx_num_im_f, inf_limits_int, inf_limits_sup, limit=100) 
...
def Ey_pols_pole_aprox(omega_omegaWG,d,R,phi,z,zp,px,py,pz):     
    ...
    for j in range(len(sup_limits)):
        ...
        termEy_pole_aprox_int_re,err = integrate.quad(termEx_num_re_f, inf_limits_int, inf_limits_sup, limit=100) 
        termEy_pole_aprox_int_im,err = integrate.quad(termEx_num_im_f, inf_limits_int, inf_limits_sup, limit=100) 

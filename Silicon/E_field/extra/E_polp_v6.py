...
#    rp = lambda u: coef_fresnel_TM_pole_aprox(omega_omegaWG,d,u)  ## u es alfa_parallel y la funcion depende de k_parallel
        ...
        termEx_pole_aprox_int_re,err = integrate.quad(termEx_num_re_f, cota_inf_alpha_parallel, cota_sup_alpha_parallel, weight='cauchy', wvar=qj_polo) 
        termEx_pole_aprox_int_im,err = integrate.quad(termEx_num_im_f, cota_inf_alpha_parallel, cota_sup_alpha_parallel, weight='cauchy', wvar=qj_polo) 
...
#            print(polo_j)
        ...
        termEy_pole_aprox_int_re,err = integrate.quad(termEx_num_re_f, cota_inf_alpha_parallel, cota_sup_alpha_parallel, weight='cauchy', wvar=qj_polo) 
        termEy_pole_aprox_int_im,err = integrate.quad(termEx_num_im_f, cota_inf_alpha_parallel, cota_sup_alpha_parallel, weight='cauchy', wvar=qj_polo) 

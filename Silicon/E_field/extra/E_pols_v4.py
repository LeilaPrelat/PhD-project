...
#    kmedium = k_parallel_medium(omega,epsilon2)
    ...
    for pole in list_poles:
        if pole - deltta > 1:
            ...
            inf_limits.append(1 + 0.001) ## el integrando diverge en kz = 0 (k parallel = k)
...
def coef_fresnel_TE_pole_aprox(omega_omegaWG,d,alpha_parallel):
    eta = 1
...
def Ex_pols_num(omega_omegaWG,d,R,phi,z,zp,px,py,pz):     
    ...
    for j in range(len(sup_limits)):
        ...
        sup_limits_int = sup_limits[j]
        
#        print(j,inf_limits_int,sup_limits_int)
...
def Ex_pols_pole_aprox(omega_omegaWG,d,R,phi,z,zp,px,py,pz):     
    ...
    rs = lambda u: coef_fresnel_TE_pole_aprox(omega_omegaWG,d,u)  ## u es alfa_parallel y la funcion depende de u
    ...
    for j in range(len(sup_limits)):
        ...
        termEx_pole_aprox_int_re,err = integrate.quad(termEx_num_re_f, inf_limits_int, sup_limits_int, limit=limitt) 
        termEx_pole_aprox_int_im,err = integrate.quad(termEx_num_im_f, inf_limits_int, sup_limits_int, limit=limitt) 
...
def Ey_pols_num(omega_omegaWG,d,R,phi,z,zp,px,py,pz):     
    ...
    for j in range(len(sup_limits)):
        ...
        termEy_num_int_re,err = integrate.quad(termEx_num_re_f, inf_limits_int, inf_limits_sup, limit=limitt) 
        termEy_num_int_im,err = integrate.quad(termEx_num_im_f, inf_limits_int, inf_limits_sup, limit=limitt) 
...
def Ey_pols_pole_aprox(omega_omegaWG,d,R,phi,z,zp,px,py,pz):     
    ...
    rs = lambda u: coef_fresnel_TE_pole_aprox(omega_omegaWG,d,u)  ## u es alfa_parallel y la funcion depende de k_parallel
    ...
    for j in range(len(sup_limits)):
        ...
        termEy_pole_aprox_int_re,err = integrate.quad(termEx_num_re_f, inf_limits_int, inf_limits_sup, limit=limitt) 
        termEy_pole_aprox_int_im,err = integrate.quad(termEx_num_im_f, inf_limits_int, inf_limits_sup, limit=limitt) 

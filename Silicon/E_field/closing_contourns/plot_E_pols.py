...
try:
    ...
    from E_pols import Ex_pols_num, Ex_pols_ana, Ey_pols_num, Ey_pols_ana, Ex_pols_pole_aprox, Ey_pols_pole_aprox
...
axs[0].plot(listx,listy_im_anaG1,'.-',ms = ms,color = 'purple')
axs[1].plot(listx,listy_im_numG1,'.-',ms = ms,color = 'lightseagreen')
axs[1].minorticks_on()
axs[1].tick_params(labelsize = tamnum,pad = pad)
axs[0].tick_params(labelsize = tamnum,pad = pad)
axs[1].set_ylabel('Full num',fontsize = tamletra,labelpad=labelpady) 
axs[0].set_ylabel('PP analytical',fontsize = tamletra,labelpad=labelpady) 
axs[1].set_xlabel(labelx,fontsize = tamletra,labelpad=labelpady)
#axs[1].title.set_text(title)
fig.savefig( 'Im_Ex2' + label1 + '.png', format='png')
...
#plt.plot(listx,listy_re_pole_aproxG2,'.-',ms = ms,color = 'darkorange',label = 'PP numerical')
plt.legend(loc = 'best',markerscale=mk,fontsize=tamlegend,frameon=0,handletextpad=0.2, handlelength=length_marker)
plt.tight_layout()
...
#plt.plot(listx,listy_im_pole_aproxG2,'.-',ms = ms,color = 'darkorange',label = 'PP numerical')
plt.legend(loc = 'best',markerscale=mk,fontsize=tamlegend,frameon=0,handletextpad=0.2, handlelength=length_marker)
plt.tight_layout()

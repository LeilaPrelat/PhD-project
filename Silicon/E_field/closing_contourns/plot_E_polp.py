...
path_save = path_basic + '/' + 'E_polp'
#if not os.path.exists(path_save):
#    print('Creating folder to save graphs')
#    os.mkdir(path_save)

err = 'E_polp.py no se encuentra en ' + path_basic
try:
    sys.path.insert(1, path_basic)
    from E_polp import Ex_polp_num, Ex_polp_ana, Ey_polp_num, Ey_polp_ana, Ez_polp_num, Ez_polp_ana
...
def Ex_real_ana(R_nano,omega_omegaWG):
    ...
    rta = Ex_polp_ana(omega_omegaWG,d,R,phi0,z0,zp,px,py,pz,epsilon_pole)
...
def Ey_real_ana(R_nano,omega_omegaWG):
    ...
    rta = Ey_polp_ana(omega_omegaWG,d,R,phi0,z0,zp,px,py,pz,epsilon_pole)
...
def Ez_real_ana(R_nano,omega_omegaWG):
    ...
    rta = Ez_polp_ana(omega_omegaWG,d,R,phi0,z0,zp,px,py,pz,epsilon_pole)

...
def Ex_polp_num(omega_omegaWG,d,R,phi,z,zp,px,py,pz):     
    ...
    termEx_num_int_re3,err = integrate.quad(termEx_num_re_f,  0.01/k1 , 0.99/k1, limit = 50)   
    termEx_num_int_im3,err = integrate.quad(termEx_num_im_f,  0.01/k1 , 0.99/k1, limit = 50)   
    termEx_num_int_3 = termEx_num_int_re3 
...
def Ex_polp_ana(omega_omegaWG,d,R,phi,z,zp,px,py,pz,epsilon_pole):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
#        print(polo_j)
        ...
        J0 = special.hankel2(0,polo_j*R)  
        J1 = special.hankel2(1,polo_j*R)  
        J2 = special.hankel2(2,polo_j*R)
...
def Ey_polp_ana(omega_omegaWG,d,R,phi,z,zp,px,py,pz,epsilon_pole):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
def Ez_polp_ana(omega_omegaWG,d,R,phi,z,zp,px,py,pz,epsilon_pole):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    

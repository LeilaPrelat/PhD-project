...
try:
    ...
    from E_PV_pols_v5 import Ex_pols_pole_aprox, Ey_pols_pole_aprox
except ModuleNotFoundError:
    print(err)

try:
    sys.path.insert(1, path_basic)
    from E_PV_polp_v5 import Ex_polp_pole_aprox, Ey_polp_pole_aprox
except ModuleNotFoundError:
    print(err)
...
#    omega_omegaWG = omega0/omegaWG
    ...
    rta1 = Ex_pols_pole_aprox(omega_omegaWG,d,R,phi0,z0,zp,px,py,pz)
    rta2 = Ex_polp_pole_aprox(omega_omegaWG,d,R,phi0,z0,zp,px,py,pz)
...
#    omega_omegaWG = omega0/omegaWG
    ...
    rta1 = Ey_pols_pole_aprox(omega_omegaWG,d,R,phi0,z0,zp,px,py,pz)
    rta2 = Ey_polp_pole_aprox(omega_omegaWG,d,R,phi0,z0,zp,px,py,pz)

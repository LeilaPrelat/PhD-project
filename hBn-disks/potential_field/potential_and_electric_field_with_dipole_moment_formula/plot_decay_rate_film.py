...
try:
    ...
    from decay_rate_film import EELS_film_ana_f, EELS_film_num_f, EELS_film_pole_aprox_f
...
def function_imag_num(energy0,int_v,zp_nano):
    ...
    rta = EELS_film_num_f(omegac0,epsi1,epsi3,d_nano,int_v,b,zp,omega0,kappa_factor_omega0,kappa_r_factor,dir_dip_moment)
...
def function_imag_pole_aprox(energy0,int_v,zp_nano):
    ...
    rta = EELS_film_pole_aprox_f(omegac0,epsi1,epsi3,d_nano,int_v,b,zp,omega0,kappa_factor_omega0,kappa_r_factor,dir_dip_moment)

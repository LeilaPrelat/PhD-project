...
def EELS_film_ana_f(omegac,epsi1,epsi3,d_nano,int_v,b,zp,dir_dip_moment):     
    """    
    Parameters
    ----------
...
def EELS_film_num_f(omegac,epsi1,epsi3,d_nano,int_v,b,zp,dir_dip_moment):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
def EELS_film_pole_aprox_f(omegac,epsi1,epsi3,d_nano,int_v,b,zp,dir_dip_moment):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
